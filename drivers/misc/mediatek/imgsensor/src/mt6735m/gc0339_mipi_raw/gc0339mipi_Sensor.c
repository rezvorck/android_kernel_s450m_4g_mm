...
#define PFX "GC_0339_camera_sensor"
#define LOG_1 LOG_INF("GC_0339,MIPI 1LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC0339MIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h

    .checksum_value = 0x9d1c9dad,        //checksum value for Camera Auto Test

    .pre = {
        .pclk = 12000000,                //record different mode's pclk
        .linelength = 960,                //record different mode's linelength
    ...
    .min_shutter = 0x20,        //min shutter
    .max_frame_length = 500,//max framelength by sensor register's limitation
...
static imgsensor_struct imgsensor = {
    ...
    .dummy_pixel = 2,                    //current dummypixel
    .dummy_line = 2,                    //current dummyline
...
static void set_dummy(void)
{
	...
	hb = imgsensor.dummy_pixel + 2;
	vb = imgsensor.dummy_line + 2;


	//Set HB
	write_cmos_sensor(0x0f, (hb >> 4)& 0x0F);

	//Set VB
	write_cmos_sensor(0x0f, vb & 0xF0);
	mdelay(50);
//  end
}    /*    set_dummy  */
...
//			LOG_INF("GC_0339 analogic gain 1x , GC_0339 add pregain = %d\n",temp);
	...
	else if((ANALOG_GAIN_2<= iReg)&&(iReg < ANALOG_GAIN_3))
	{
			...
			write_cmos_sensor(0xb1, temp>>6);
			write_cmos_sensor(0xb2, (temp<<2)&0xfc);
//			LOG_INF("GC_0339 analogic gain 1.45x , GC_0339 add pregain = %d\n",temp);
	...
	else if((ANALOG_GAIN_3<= iReg)&&(iReg < ANALOG_GAIN_4))
	{
			...
			write_cmos_sensor(0xb1, temp>>6);
			write_cmos_sensor(0xb2, (temp<<2)&0xfc);
//			LOG_INF("GC_0339 analogic gain 2.02x , GC_0339 add pregain = %d\n",temp);
	}
...
//			LOG_INF("GC_0339 analogic gain 2.8x, temp = %d\n", temp);
	}

*/
         write_cmos_sensor(0x51, iReg);
	return gain;
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
	...
	//		GC_0339_write_cmos_sensor(0x92,0x03);
	//		GC_0339_write_cmos_sensor(0x94,0x0b);
			break;
		case IMAGE_V_MIRROR://IMAGE_V_MIRROR:
	//		write_cmos_sensor(0x17,0x16);
	//		GC_0339_write_cmos_sensor(0x92,0x02);
	//		GC_0339_write_cmos_sensor(0x94,0x0b);
			break;
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x01,0x0a);// HB[7:0]
	write_cmos_sensor(0x02,0x0c);//VB[7:0]
