...
#define LEDS_DEBUG(format, args...) //do{ printk("[LED]"format, ##args); } while(0)
...
int pmic_freqsel_array[] = { 14, 18, 199, 499, 999, 1999, 1999, 1999 };
...
int mt_led_blink_pmic(enum mt65xx_led_pmic pmic_type, struct nled_setting *led)
{
	...
	case MT65XX_LED_PMIC_NLED_ISINK0:
		...
		pmic_set_register_value(PMIC_ISINK_DIM0_DUTY, duty+14);
